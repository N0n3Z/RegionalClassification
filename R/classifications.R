...
#' | From                          | To                               | Type   |
#' |-------------------------------|----------------------------------|--------|
#' | `NIS_COMMUNE_BEFORE_2019`     | `NIS_ARRONDISSEMENT_BEFORE_2019` | (y) N:1  |
#' | `NIS_COMMUNE_BEFORE_2019`     | `NIS_REGION_BEFORE_2019`         | (y) N:1  |
#' | `NIS_ARRONDISSEMENT_BEFORE_2019` | `NIS_PROVINCE_BEFORE_2019`    | (y) N:1  |
#' | `NIS_PROVINCE_BEFORE_2019`    | `NIS_REGION_BEFORE_2019`         | (!) M:N  |
#' | `NIS_COMMUNE_BEFORE_2019`     | `NIS_COMMUNE_2019`               | (y) N:1  |
#' | `NIS_COMMUNE_BEFORE_2019`     | `NUTS3_2021`                     | (y) N:1  |
#' | `NIS_COMMUNE_BEFORE_2019`     | `NUTS3_2027`                     | (y) N:1  |
#' | `NIS_COMMUNE_2019`            | `NIS_ARRONDISSEMENT_2019`        | (y) N:1  |
#' | `NIS_COMMUNE_2019`            | `NIS_REGION_2019`                | (y) N:1  |
#' | `NIS_ARRONDISSEMENT_2019`     | `NIS_PROVINCE_2019`              | (y) N:1  |
#' | `NIS_PROVINCE_2019`           | `NIS_REGION_2019`                | (!) M:N  |
#' | `NIS_COMMUNE_2019`            | `NIS_COMMUNE_2025`               | (y) N:1  |
#' | `NIS_COMMUNE_2019`            | `NUTS_LAU_2021`                  | (y) 1:1  |
#' | `NIS_COMMUNE_2019`            | `NUTS3_2027`                     | (y) N:1  |
#' | `NIS_ARRONDISSEMENT_2019`     | `NUTS3_2021`                     | (!) 1:N  |
#' | `NIS_ARRONDISSEMENT_2019`     | `INTERNAL_ARRONDISSEMENT`        | (!) 1:N  |
#' | `NIS_COMMUNE_2025`            | `NIS_ARRONDISSEMENT_2025`        | (y) N:1  |
#' | `NIS_COMMUNE_2025`            | `NIS_REGION_2025`                | (y) N:1  |
#' | `NIS_ARRONDISSEMENT_2025`     | `NIS_PROVINCE_2025`              | (y) N:1  |
#' | `NIS_PROVINCE_2025`           | `NIS_REGION_2025`                | (!) M:N  |
#' | `NIS_COMMUNE_2025`            | `NUTS3_2027`                     | (y) N:1  |
#' | `NIS_COMMUNE_2025`            | `NUTS2_2027`                     | (y) N:1  |
#' | `NIS_COMMUNE_2025`            | `NUTS1_2027`                     | (y) N:1  |
#' | `NUTS_LAU_2021`               | `NUTS3_2021`                     | (y) N:1  |
#' | `NUTS3_2021`                  | `NUTS2_2021`                     | (y) N:1  |
#' | `NUTS2_2021`                  | `NUTS1_2021`                     | (y) N:1  |
#' | `NUTS1_2021`                  | `NUTS0`                          | (y) N:1  |
#' | `NUTS3_2027`                  | `NUTS2_2027`                     | (y) N:1  |
#' | `NUTS2_2027`                  | `NUTS1_2027`                     | (y) N:1  |
#' | `NUTS1_2027`                  | `NUTS0`                          | (y) N:1  |
#' | `NUTS3_2021`                  | `INTERNAL_ARRONDISSEMENT`        | (y) 1:1  |
#' | `POSTAL`                      | `NIS_COMMUNE_2019`               | (y) N:1  |
#' | `POSTAL`                      | `NIS_COMMUNE_2025`               | (y) N:1  |
#' | `POSTAL`                      | `NUTS3_2027`                     | (y) N:1  |
#'
