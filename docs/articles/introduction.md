...
Organised by level; versions are listed within each level (not as
separate rows).

| Level | Identifiers (per version) |
|----|----|
| NIS communes | `NIS_MUNICIPALITY_BEFORE_2019`, `_2019`, `_2025` |
...
| NUTS country (NUTS 0) | `NUTS_COUNTRY` |
