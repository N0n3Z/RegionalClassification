...
\`NIS_PROVINCE_2019\` \| Provinces (2019) \| \| \`NIS_REGION_2019\` \|
Regions (2019) \| \| \`NIS_MUNICIPALITY_2025\` \| Communes (2025
version) \| \| \`NIS_DISTRICT_2025\` \| Arrondissements (2025) \| \|
\`NIS_PROVINCE_2025\` \| Provinces (2025) \| \| \`NIS_REGION_2025\` \|
Regions (2025) \| \| \`NIS_COUNTRY\` \| Country level (Belgium, NIS code
1000) – version-invariant \|

\## NUTS classifications (Eurostat)

\| Canonical identifier \| Description \| \|———————-\|—————————————-\|
\| \`NUTS_MUNICIPALITY_2021\` \| Local Administrative Units (2021) – in
Belgium, bijection 1:1 with \`NIS_MUNICIPALITY_2019\` (same territory,
Eurostat coding) \| \| \`NUTS_DISTRICT_2021\` \| NUTS level 3 (2021) \|
\| \`NUTS_PROVINCE_2021\` \| NUTS level 2 (2021) \| \|
\`NUTS_REGION_2021\` \| NUTS level 1 (2021) \| \| \`NUTS_COUNTRY\` \|
Country level (BE) – version-invariant \| \| \`NUTS_DISTRICT_2027\` \|
NUTS level 3 (2027) \| \| \`NUTS_PROVINCE_2027\` \| NUTS level 2 (2027)
