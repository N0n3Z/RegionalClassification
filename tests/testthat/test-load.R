...
# ── Test L1: structure retournée par load_master_data ─────────────────────────
...
# ── Test L4: postal table contient des données ────────────────────────────────
...
# ── Test L5: nis_changes table est présente ───────────────────────────────────
...
# ── Test L6: erreur rcl_data_missing pour répertoire inexistant ───────────────
...
# ── Test L8: toutes les régions belges sont présentes ─────────────────────────
