...
test_that("convert_codes raises rcl_invalid_input for non-list master_data", {
  expect_error(
    convert_codes(21004L, CLS_NIS_MUNICIPALITY_2019, CLS_NUTS_DISTRICT_2021, "not_a_list"),
...
test_that("convert_codes raises rcl_data_missing when communes table missing", {
  ...
  expect_error(
    convert_codes(21004L, CLS_NIS_MUNICIPALITY_2019, CLS_NUTS_DISTRICT_2021, bad_md),
