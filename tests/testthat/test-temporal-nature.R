...
test_that("convert_codes returns CHANGE_DSTR for commune 44045 (arr change -> 46029)", {
  r <- convert_codes(44045L, CLS_NIS_COMMUNE_2019, CLS_NIS_COMMUNE_2025, master_data)
...
test_that("convert_codes returns CHANGE_DSTR for commune 73040 (arr change -> 71072)", {
  r <- convert_codes(73040L, CLS_NIS_COMMUNE_2019, CLS_NIS_COMMUNE_2025, master_data)
  expect_equal(r$nature,   "CHANGE_DSTR")
...
test_that("convert_codes returns CHANGE_PROV for commune 11056 (prov change -> 46030)", {
  r <- convert_codes(11056L, CLS_NIS_COMMUNE_2019, CLS_NIS_COMMUNE_2025, master_data)
...
test_that("reverse temporal conversion preserves CHANGE_DSTR (46029 contains 44045)", {
  ...
  r <- convert_codes(46029L, CLS_NIS_COMMUNE_2025, CLS_NIS_COMMUNE_2019,
...
test_that("reverse temporal conversion preserves CHANGE_PROV (46030 contains 11056)", {
  ...
  r <- convert_codes(46030L, CLS_NIS_COMMUNE_2025, CLS_NIS_COMMUNE_2019,
                     master_data, allow_ambiguous = TRUE)
...
test_that("FUSION commune returns nature='FUSION'", {
  ...
  r <- convert_codes(11007L, CLS_NIS_COMMUNE_2019, CLS_NIS_COMMUNE_2025, master_data)
...
test_that("batch temporal conversion carries the correct nature per code", {
  ...
  r     <- convert_codes(codes, CLS_NIS_COMMUNE_2019, CLS_NIS_COMMUNE_2025, master_data)
...
test_that("all 2019->2025 temporal nature values are in {UNCHANGED,FUSION,CHANGE_DSTR,CHANGE_PROV}", {
  ...
  r        <- convert_codes(all_2019, CLS_NIS_COMMUNE_2019, CLS_NIS_COMMUNE_2025, master_data)
...
test_that("all BEFORE_2019->2019 nature values are in {UNCHANGED, FUSION} or NA", {
  ...
  r       <- suppressWarnings(
    convert_codes(all_b19, CLS_NIS_COMMUNE_BEFORE_2019, CLS_NIS_COMMUNE_2019, master_data)
  )
